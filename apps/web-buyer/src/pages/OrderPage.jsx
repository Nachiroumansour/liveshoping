  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/${linkId}/confirmation`, {
        state: { order: result.order, product, seller }
      });
    } catch (err) {
      setError(err.message);
    } finally {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-base font-semibold text-gray-900 mb-1">Produit non trouvé</p>
          ...
          <div className="bg-white rounded-2xl overflow-hidden">
            ...
            <div className="px-5 py-3.5 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400">{product?.price.toLocaleString()} FCFA / unité</p>
              </div>
            </div>
            ...
            <div className="px-5 py-3 border-t border-gray-50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-gray-900 w-6 text-center">{formData.quantity}</span>
                <button
                  type="button"
            ...
            <div className="px-5 py-3.5 bg-gray-50/50 flex justify-between items-center">
              ...
              <span className="text-base font-bold text-gray-900">{totalPrice.toLocaleString()} FCFA</span>
            </div>
          </div>
            ...
            <div className="space-y-2.5">
              <button
                ...
                className={`w-full flex items-center gap-3 p-3.5 rounded-xl border transition-all ${
                  formData.payment_method === 'wave' ? 'border-gray-900 bg-gray-50' : 'border-gray-100 bg-white'
                }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 p-3.5 rounded-xl border transition-all ${
                  formData.payment_method === 'orange_money' ? 'border-gray-900 bg-gray-50' : 'border-gray-100 bg-white'
                }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 p-3.5 rounded-xl border transition-all ${
                  formData.payment_method === 'cash' ? 'border-gray-900 bg-gray-50' : 'border-gray-100 bg-white'
                }`}
              >
            ...
            {(formData.payment_method === 'wave' || formData.payment_method === 'orange_money') && (
              <div className="bg-gray-50 rounded-xl p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-gray-900">{totalPrice.toLocaleString()} FCFA</span>
                </div>
          ...
          <div className="relative bg-white rounded-2xl max-w-sm w-full p-6">
            <div className="text-center">
              ...
              <div className="mb-5">
                ...
                <p className="text-sm text-gray-500 mb-1">Montant : <span className="font-semibold text-gray-900">{totalPrice.toLocaleString()} FCFA</span></p>
