...
const SEO = ({ 
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="LiveShop Link" />
      ...
      <meta property="og:site_name" content="LiveShop Link" />
      ...
      <meta name="twitter:creator" content="@liveshoplink" />
      ...
      <meta name="apple-mobile-web-app-title" content="LiveShop Link" />
